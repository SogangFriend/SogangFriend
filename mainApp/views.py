...
class HomeView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        for_all = file_path+ member_info.location.si.name + '.geojson'
        with open(for_all, 'r') as f:
            json_for_all = json.load(f)
        ...
        return render(request, "homepage.html",
                      {'member_info': member_info, 'json_for_all' : json_for_all,
                       'json_data': json_data})  # 로그인을 했다면, home 출력
